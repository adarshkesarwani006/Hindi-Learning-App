...
public class ColorsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("yellow", "पीला", R.drawable.color_mustard_yellow,
                R.raw.color_yellow));
        words.add(new Word("dusty yellow", "हल्का पीला", R.drawable.color_dusty_yellow,
        ...
        words.add(new Word("gray", "ग्रे", R.drawable.color_gray, R.raw.color_gray));
        words.add(new Word("black", "काला", R.drawable.color_black, R.raw.color_black));
        words.add(new Word("white", "सफ़ेद", R.drawable.color_white, R.raw.color_white));
