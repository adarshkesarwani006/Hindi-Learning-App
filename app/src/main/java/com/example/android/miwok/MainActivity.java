    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        numbers.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // In Above code to connect Numbers Activity(Screen) we are creating a new intent in which we are
                ...
                //           Here in NumbersActivity.class file the new Activity screen is coded.
